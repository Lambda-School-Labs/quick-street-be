  ...
  return knex("users")
    ...
    .then(function () {
      ...
      return knex("users").insert([
        ...
        { email: "snake@snake.com", password: "slither", isVendor: 1, isAdmin: 0 },
        { email: "gunner@dog.com", password: "feedme", isVendor: 0, isAdmin: 0 },
        { email: "speedy@cat.com", password: "run", isVendor: 0, isAdmin: 0 },
        { email: "slimy@snake.com", password: "snake", isVendor: 0, isAdmin: 0 },
        {
